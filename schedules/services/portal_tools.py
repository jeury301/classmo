...
def student(student_action):
    ...
    """
    def filtered_student_action(request, **kargs):
        ...
        if is_student:
            ...
            return student_action(request, **kargs)
        else:
            return redirect("/")
    return filtered_student_action


def instructor(instructor_action):
    ...
    """
    def filtered_instructor_action(request, **kargs):
        ...
        if is_instructor:
            ...
            return instructor_action(request, **kargs)
        else:
            return redirect("/")

...
def create_demo(subjects, instructors):
    ...
    post_content = [('Is everyone doing their yoga exercises? I hope so',
                     '...cause some of those yoga poses I saw were pretty NOT SO GOOD.'),
                    ('Bogo Yoga in the news.',
                     "It's true - check out the Woodstock Patch, May issue."),
                    ("Big time Y.O.G.A. champion coming to Woodstock",
                     "I have no idea what Yolo Omega Goat Academics involves, but it sounds interesting"),
                    ("Large cat alert in Woodstock!",
                     "This mini monster is going to eat a human if we don't band together and keep our wits about us."),
                    ("Did anyone see Fantasia?",
                    ...
                    ("Seeking mystical partners for a journey to the east....",
                     "Who doesn't like yoga??"),
                    ("Plastic bags at the grocery store?!",
                     "Do you WANT to destory our planet!? Unbelievable."),
                    ("Best yoga pose in my opinion is...",
                      "The GLAMOUR pose"),
                    ("Did anyone lose a yoga mat sandwich in the Chakra Courtyard?",
